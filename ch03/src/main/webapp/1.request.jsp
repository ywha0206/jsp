...
<head>
	...
	<!-- 
		...
		GET 요청
		- GET 요청방식은 HTTP 기본 요청 방식
		- GET은 서버에 있는 자원을 요청하는 요청방식
		- GET요청으로 데이터를 전송할 때는 Query String (Parameter)로 요청주소에 노출되어 전송
		
		POST 요청
		- Post는 사용자가 입력한 값을 서버로 전송하기 위한 요청방식
		- 입력한 전송 데이터는 주소에 노출되지 않고 요청 메세지 바디에 삽입되어 전송
